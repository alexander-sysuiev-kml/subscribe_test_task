...
- I considered avoiding a decorator for StoredEntity, but it could lead to internal recursion in tax calculation. So placing the DAO with the decorator seems like the canonical approach in this case.
